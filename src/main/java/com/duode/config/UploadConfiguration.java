...
public class UploadConfiguration extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/images/**").addResourceLocations("file:/duode/dituo/dituo/images/");
        registry.addResourceHandler("/video/**").addResourceLocations("file:/duode/dituo/dituo/video");
    }
}
